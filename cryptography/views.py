...
from .models import Cryptography_Challenges as cc
from django.urls import reverse
from django.contrib import messages
from cryptography.models import Cryptography_Challenges_solved 
...
def cryptography(request):
    ...
    mydata=Cryptography_Challenges_solved.objects.filter(Username=request.user).values()
    
    

    return render(request,'crypto.html',{'challenges':challenges,'mp':mydata})
